...
const SessionsAnHour: React.FC = () => {
    ...
    const getInfo = () => {
        axios.get(`http://localhost:3001/events/by-hours/${date}`).then(r => {setInfo(r.data)});
    };
    ...
    return <div>
        <Title>Sessions Each Hour</Title>
